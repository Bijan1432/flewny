...
// Fetch data
$sql = 'SELECT id FROM blog_author'; //set query
$query = mysqli_query($connection, $sql); // convert Query
$total_blog_author = mysqli_num_rows($query); // total blog_author

$total_pages = ceil($total_blog_author / $limit); // Calculate total pages
...
$sql = "SELECT * FROM blog_author LIMIT $limit OFFSET $offset";
...
if (isset($_GET['edit_id'])) {
    ...
    // fetch data of this blog_author
    $category_sql = "SELECT * FROM blog_author WHERE id = '$category_id'";
    $category_query = mysqli_query($connection, $category_sql);
    $blog_author = mysqli_fetch_array($category_query);
}
...
<body>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Blog Author</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="white-box">
                            <div class="">
                                <h4 class="box-title m-b-0"><?php echo isset($_GET['edit_id']) ? 'Edit author -> ' . $blog_author[1] : 'Add Author'; ?></h4>
                            </div>
                            ...
                            <div class="posting-form pt-5">
                                ...
                                ?>
                                    <!-- edit form  -->
                                    <form action="./functions/author_backend.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="name" class="form-control" id="exampleCategoryName" value="<?php echo $blog_author['name'] ?>" placeholder="Author name*" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="slug" class="form-control" value="<?php echo $blog_author['slug'] ?>" id="exampleCategorySlug" placeholder="Slug*" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="meta_description" class="form-control" value="<?php echo $blog_author['meta_description'] ?>" id="exampleCategorySlug" placeholder="Description">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4 ">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="active_status" id="examplePublished" class="custom-select w-100 py-0" style="height: calc(3.8rem);" data-value="<?php echo  $blog_author['active_status'] ?>" required="">
                                        ...
                                        <input type="hidden" name="edit_id" value="<?php echo $blog_author['id'] ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-9 col-sm-12 col-xs-12 mail_listing">
                                    <div class="inbox-center">
                                        ...
                                        <div class="">
                                            <h4>All Blog Author (<b style="color: orange;"><?php echo $total_blog_author; ?></b>)</h4>
                                            <?php
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="hidden-xs"> <a href=<?php echo './author.php?name=' . $row["slug"] ?> target="_blank"><?php echo $row["name"] ?></a> </td>
                                                        ...
                                                        <td class="hidden-xs d-flex align-items-center">
                                                            <a href="./author.php?edit_id=<?php echo $row["id"] ?>"><i class="ti-pencil p-2 mr-2 text-primary align-middle h3" data-toggle="tooltip" data-placement="bottom" title="Edit"></i></a>
                                    ...
                                    <div class=" row align-items-center">
                                        <div class="col-xs-7 m-t-20"> Showing 1 - <?php echo $total_blog_author ?></div>
                                        <div class="col-xs-5 m-t-20">
                                            <div class="btn-group pull-right">
                                                <a href="./author.php?page=<?php echo $page - 1; ?>&limit=<?php echo $limit; ?>" class="btn btn-default waves-effect"><i class="fa fa-chevron-left"></i></a>
                                                <a href="./author.php?page=<?php echo $page + 1; ?>&limit=<?php echo $limit; ?>" class="btn btn-default waves-effect"><i class="fa fa-chevron-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $('#exampleModalCenter').on('show.bs.modal', function(e) {
            ...
            $('#selectedBlog').attr("href", `./functions/author_backend.php?delete_id=${e.relatedTarget.dataset.id}`)
        })
