            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-10">
                        <div class="white-box">
                            <div class="">
                                <h3 class="box-title m-b-0">Edit this Blog </h3>
                                <p class="text-muted m-b-30 font-13"> Editing a blog is where words evolve, shaping clarity from creativity.</p>
                            </div>

                            <div class="posting-form">
                                <form action="./functions/blog_update.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="title" class="form-control" id="exampleBlogTitle" value="<?php echo $blog['title'] ?>" placeholder="Title*" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="slug" class="form-control" id="exampleBlogSlug" value="<?php echo $blog['slug'] ?>" placeholder="Slug*" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <select name="category" id="exampleBlogCategory" class="custom-select w-100 py-0" style="height: calc(3.8rem);" required="" data-value="<?php echo $blog['category'] ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" name="intro" class="form-control" id="exampleBlogIntro" value="<?php echo $blog['intro'] ?>" placeholder="intro*">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="file" name="blog_image" accept=".jpg, .jpeg, .png, .webp" class="form-control" id="exampleBlogImage" value="<?php echo $blog['blog_image'] ?>">
                                                    <input type="hidden" name="blog_image_name" value="<?php echo $blog['blog_image'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" name="blog_image_alt" class="form-control" id="exampleBlogImageAlt" value="<?php echo $blog['blog_image_alt'] ?>" placeholder="Image Alt">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" name="published_date" class="form-control" id="exampleInputEmail1" value="<?php echo $blog['published_date'] ?>" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <select name="published_status" id="examplePublished" class="custom-select w-100 py-0" style="height: calc(3.8rem);" data-value="<?php echo  $blog['published_status'] ?>" required="">
                                                        <option value="">Select</option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="meta_title" class="form-control" id="exampleMetaTitle" value="<?php echo $blog['meta_title'] ?>" placeholder="Meta Title*" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="meta_keywords" class="form-control" id="exampleBlogSlug" value="<?php echo $blog['meta_keywords'] ?>" placeholder="Keywords*" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="meta_description" class="form-control" id="exampleBlogSlug" value="<?php echo $blog['meta_description'] ?>" placeholder="Description*" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="meta_canonical" id="exampleCanonicalLink" value="<?php echo $blog['meta_canonical'] ?>" class="form-control" placeholder="Canonical Link">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="tags" id="exampleCanonicalLink" value="<?php echo $blog['tags'] ?>" class="form-control" placeholder="Tags">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
