...
$sql_posts = "SELECT * FROM blogs";
$query_posts = mysqli_query($connection, $sql_posts);

$sql_active_blogs = "SELECT * FROM blogs WHERE published_status = 1";
$query_active_blogs = mysqli_query($connection, $sql_active_blogs);
                            ...
                            <div class="row row-in">
                                <div class="col-lg-3 col-sm-6 row-in-br">
                                    <div class="col-in row">
                                        <div class="col-md-10 col-sm-6 col-xs-6"> <i data-icon="E" class="linea-icon linea-basic"></i>
                                            <h5 class="text-muted vb">Marko & Brando Blog Posts</h5>
                                        </div>
                                ...
                                <div class="col-lg-3 col-sm-6 row-in-br  b-r-none">
                                    <div class="col-in row">
                                        <div class="col-md-10 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                                            <h5 class="text-muted vb">Active Blog</h5>
                                        </div>
                                        <div class="col-md-2 col-sm-6 col-xs-6">
                                            <h3 class="counter text-right m-t-15 text-megna"><?php echo mysqli_num_rows($query_active_blogs); ?></h3>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="progress">
                                ...
                                <!-- <div class="col-lg-3 col-sm-6 row-in-br  b-r-none">
                                    <div class="col-in row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h3 class="counter text-right m-t-15 text-megna"><?php //echo mysqli_num_rows($query_comments); 
                                                                                                ?></h3>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="progress">
                    ...
                    <div class="col-md-12 col-lg-6 col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="row sales-report">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6 ">
                                    <h1 class="text-right text-success m-t-20 pr-md-5"><?php echo mysqli_num_rows($query_posts); ?></h1>
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table ">
                                    ...
                                    while (($row = mysqli_fetch_array($query_posts)) and ($counter < $max)) {
                                        ...
                                        <tr>
                                           ...
                                           <td class="txt-oflo">' . $row["published_date"] . '</td>
                                ...
                                <a href="blogs.php" class="btn btn-info btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">View All Posts</a>
                            </div>
                        </div>
                    </div>
                </div>
