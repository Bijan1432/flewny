    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form id="validation" class="form-horizontal" action="functions/new_post.php" enctype="multipart/form-data" method="post">
                            <div class="wizard-cogntent">
                                <div class="wizard-pfane active" role="tabpanel">
                                ...
                                <div class="wizafrd-pane" role="tabpanel">
                                    <div class="form-group">
                                ...
                                <div class="wizfard-pane" role="tabpanel">
                                    <div class="form-group">
